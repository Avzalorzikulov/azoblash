...
const Newsletter = () => {
  return (
    <div className="max-w-md mx-auto py-8 px-6 sm:px-12 border-b border-gray-300">
      {/* Title */}
      ...
      <p className="text-sm text-gray-600 text-center sm:text-left">
        We usually post offers and challenges in the newsletter. We&apos;re your online houseplant
